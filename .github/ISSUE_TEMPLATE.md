...
This issue tracker is only for technical issues related to CapitalCoin Core.
General CAP questions and/or support requests and are best directed to the [CAP Slack](http://cap.slack.com).
...
### What version of CapitalCoin Core are you using?
