Contributing to CapitalCoin Core
============================

The CapitalCoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the cap unit tests or QA tests
...
The following applies to code changes to the CapitalCoin Core project, and is not to be
confused with overall CAP Network Protocol consensus changes.

Whether a pull request is merged into CapitalCoin Core rests with the project merge
...
Patches that change CAP consensus rules are considerably more involved than
...
Where a patch set proposes to change the CAP consensus, it must have been
...
The project leader is the release manager for each CapitalCoin Core release.
