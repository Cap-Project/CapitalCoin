...
#if defined(NDEBUG)
#error "CAP cannot be compiled without assertions."
#endif
...
bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    if (!IsBlockValueValid(block, nExpectedMint, pindex->nMint) && (Params().NetworkID() != CBaseChainParams::TESTNET)) {
