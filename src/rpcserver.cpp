...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CapitalCoin features */
        {"cap", "masternode", &masternode, true, true, false},
        {"cap", "masternodelist", &masternodelist, true, true, false},
        {"cap", "mnbudget", &mnbudget, true, true, false},
        {"cap", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cap", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cap", "mnsync", &mnsync, true, true, false},
        {"cap", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cap", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use capd, or the -server option to cap-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9490/\n";
}
