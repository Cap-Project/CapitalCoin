...
This mechanism has been integrated into Bitcore-Node-CAP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Cap-Project/insight-api-cap#web-socket-api](https://github.com/Cap-Project/insight-api-cap#web-socket-api)
* API: [https://github.com/Cap-Project/insight-api-cap#swifttx-transactions](https://github.com/Cap-Project/insight-api-cap#swifttx-transactions)
...
By default, the CapitalCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CapitalCoin Core daemon:
