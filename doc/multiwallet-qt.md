...
In order to support loading of multiple wallets in cap-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cap.cpp.
...
Changes to cap.cpp
----------------------
cap.cpp is the entry point into cap-qt, and as such, will require some minor modifications to provide hooks for
