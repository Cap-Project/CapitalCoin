...
RESOURCES += src/qt/cap.qrc src/qt/cap_locale.qrc

TRANSLATIONS += src/qt/locale/cap_bg.ts \
                src/qt/locale/cap_de.ts \
                src/qt/locale/cap_en.ts \
                src/qt/locale/cap_es.ts \
                src/qt/locale/cap_fi.ts \
                src/qt/locale/cap_fr.ts \
                src/qt/locale/cap_it.ts \
                src/qt/locale/cap_ja.ts \
                src/qt/locale/cap_pl.ts \
                src/qt/locale/cap_pt.ts \
                src/qt/locale/cap_ru.ts \
                src/qt/locale/cap_sk.ts \
                src/qt/locale/cap_sv.ts \
                src/qt/locale/cap_vi.ts \
                src/qt/locale/cap_zh_CN.ts \
                src/qt/locale/cap_zh_TW.ts
